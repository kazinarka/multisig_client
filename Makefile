...
approve_local:
	cargo run -- approve -e -s /Users/illiafedotov/.config/solana/id.json -m 8on7RnsMroPF79UMdb9VH9tX6KMaSDDFfGZqwr48y5n4 -i 0
...
create_multisig_local:
	cargo run -- create_multisig -e -s /Users/illiafedotov/.config/solana/id.json -o 4kMtMnYWFbsMc7M3jcdnfCceHaiXmrqaMz2QZQAmn88i -t 1
...
create_transaction_local:
	cargo run -- create_transaction -e -s /Users/illiafedotov/.config/solana/id.json -m 6rdzzuXTTsVCNHSPCeLhBDwedUtHbaJQri1MvLUJiNoa
